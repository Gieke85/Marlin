 ...
 */
  ...
  #define MIN_PROBE_EDGE_LEFT 30    //MIN_PROBE_EDGE
  #define MIN_PROBE_EDGE_RIGHT 45   //MIN_PROBE_EDGE
  #define MIN_PROBE_EDGE_FRONT 35   //MIN_PROBE_EDGE
  #define MIN_PROBE_EDGE_BACK 30    //MIN_PROBE_EDGE
#endif

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  //#define MESH_MIN_X MESH_INSET
  #define MESH_MIN_Y 35 //MESH_INSET
  #define MESH_MAX_X X_BED_SIZE - (35) //(MESH_INSET)
